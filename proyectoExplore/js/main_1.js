...
open6.addEventListener('click',() => {
    modal_container6.classList.add('show6');
   
});
close6.addEventListener('click',() => {
    modal_container6.classList.remove('show6');
});
// modal7
...
open7.addEventListener('click',() => {
    modal_container7.classList.add('show7');
   
});
close7.addEventListener('click',() => {
    modal_container7.classList.remove('show7');
});
// modal 8
...
open8.addEventListener('click',() => {
    modal_container8.classList.add('show8');
   
});
close8.addEventListener('click',() => {
    modal_container8.classList.remove('show8');
});
...
open9.addEventListener('click',() => {
    modal_container9.classList.add('show9');
   
});
close9.addEventListener('click',() => {
    modal_container9.classList.remove('show9');
});
// modal 10
...
open10.addEventListener('click',() => {
    modal_container10.classList.add('show10');
   
});
close10.addEventListener('click',() => {
    modal_container10.classList.remove('show10');
});
// modal 11
...
open11.addEventListener('click',() => {
    modal_container11.classList.add('show11');
   
});
close11.addEventListener('click',() => {
    modal_container11.classList.remove('show11');
});
// modal 12
...
open12.addEventListener('click',() => {
    modal_container12.classList.add('show12');
   
});
close12.addEventListener('click',() => {
    modal_container12.classList.remove('show12');
});
// modal 13 
...
open13.addEventListener('click',() => {
    modal_container13.classList.add('show13');
   
});
close13.addEventListener('click',() => {
    modal_container13.classList.remove('show13');
});
// modal 14
...
open14.addEventListener('click',() => {
    modal_container14.classList.add('show14');
